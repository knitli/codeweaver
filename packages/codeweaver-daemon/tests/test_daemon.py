...
@pytest.mark.asyncio
async def test_check_daemon_health_success():
...
@pytest.mark.asyncio
async def test_check_daemon_health_failure():
    mock_client = AsyncMock()
...
def test_get_daemon_cmd_and_args_default():
...
def test_get_daemon_cmd_and_args_with_binary():
