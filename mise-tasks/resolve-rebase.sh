...
# [MISE] description="Automates git merge conflict resolution during rebase, favoring main branch changes except for specified file types requiring manual review."
...
# [USAGE] version="0.1.0"
# [USAGE] license="MIT OR Apache-2.0"
# [USAGE] help="Automates git merge conflict resolution during rebase, favoring main branch changes except for specified file types requiring manual review."
# [USAGE] before_long_help="## Automated Git Rebase Conflict Resolver"
# [USAGE] long_about=r#"This script automates the resolution of git merge conflicts during a rebase. It's intended for situations where a branch is being rebased onto main, and main is significantly ahead.
...
# [USAGE] flag "-b --base-branch" default="main" help="The base branch onto which the current branch is being rebased. Defaults to 'main'."
# [USAGE] flag "-t --target-branch" default="{{ exec(command='$(git rev-parse --abbrev-ref HEAD)', default='HEAD') }}" help="The branch that is being rebased. Defaults to current branch."
