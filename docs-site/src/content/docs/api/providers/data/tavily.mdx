...
We expose our own tailored version of the `search` endpoint. With our settings the search results are filtered and curated to ensure relevance and quality, limiting context rot.
