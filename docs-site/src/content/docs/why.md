---
title: Why CodeWeaver?
description: Understanding the motivation and philosophy behind CodeWeaver
---
...
- **Precise retrieval** using hybrid search
- **Smart chunking** that respects code structure
- **Minimal overhead** in the MCP protocol
- **Quality over quantity** in every context decision

This isn't just theory - it's measurable in reduced token usage and better agent performance.
