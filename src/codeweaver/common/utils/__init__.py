...
_dynamic_imports: MappingProxyType[str, tuple[str, str]] = MappingProxyType({
    ...
    "get_daemon_status": (__spec__.parent, "procs"),
    ...
    "get_pid_file_path": (__spec__.parent, "procs"),
    ...
    "is_process_running": (__spec__.parent, "procs"),
    ...
    "read_pid_file": (__spec__.parent, "procs"),
    "remove_pid_file": (__spec__.parent, "procs"),
    "rpartial": (__spec__.parent, "utils"),
    "sanitize_unicode": (__spec__.parent, "normalize"),
    "set_relative_path": (__spec__.parent, "git"),
    "terminate_process": (__spec__.parent, "procs"),
    ...
    "write_pid_file": (__spec__.parent, "procs"),
})
