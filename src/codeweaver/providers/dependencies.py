...
def _resolve_provider_settings[
    ...
    if isinstance(settings, tuple):
        return next(iter(settings), None)
    return settings
...
class ProviderDict(TypedDict):
    ...
    embedding: tuple[EmbeddingProvider, ...]
    sparse_embedding: tuple[SparseEmbeddingProvider, ...]
    reranking: tuple[RerankingProvider, ...]
    vector_store: tuple[VectorStoreProvider, ...]
...
"""Assembled configured capabilities for providers."""
