...
_dynamic_imports: MappingProxyType[str, tuple[str, str]] = MappingProxyType({
    ...
    "AnthropicAgentProviderSettingsType": (__spec__.parent, "agent"),
    ...
    "AzureClientOptionsType": (__spec__.parent, "embedding"),
    ...
    "CoreEmbeddingProviderSettingsType": (__spec__.parent, "embedding"),
    ...
    "NonAnthropicAgentProviderSettingsType": (__spec__.parent, "agent"),
