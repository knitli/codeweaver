...
OPERATOR_SYMBOLS = (  # sort by variable length descending to match longer strings with substrings also in the list
    "is not",
    "not in",
    "$((",
    "%i(",
...
CLASSIFICATION_PATTERNS: dict[SemanticNodeCategory, tuple[str, ...]] = {
