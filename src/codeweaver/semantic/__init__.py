...
_dynamic_imports: MappingProxyType[str, tuple[str, str]] = MappingProxyType({
    ...
    "CategoryName": (__spec__.parent, "_types"),
    "ClassificationMethod": (__spec__.parent, "classifier"),
    "CompositeThing": (__spec__.parent, "grammar"),
    "ConnectionClass": (__spec__.parent, "_types"),
    "ConnectionConstraint": (__spec__.parent, "_types"),
