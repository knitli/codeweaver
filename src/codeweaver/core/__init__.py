...
_dynamic_imports: MappingProxyType[str, tuple[str, str]] = MappingProxyType({
    ...
    "UNSET": (__spec__.parent, "models"),
    "AnonymityConversion": (__spec__.parent, "models"),
    "BaseDataclassEnum": (__spec__.parent, "models"),
    "BaseEnum": (__spec__.parent, "models"),
    "BaseEnumData": (__spec__.parent, "models"),
    "BasedModel": (__spec__.parent, "models"),
    "CategoryName": (__spec__.parent, "models"),
    "CategoryNameT": (__spec__.parent, "models"),
