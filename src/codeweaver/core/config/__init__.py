...
_dynamic_imports: MappingProxyType[str, tuple[str, str]] = MappingProxyType({
    ...
    "LiteralProviderCategoryType": (__spec__.parent, "envs"),
    ...
    "MappingProxyType": (__spec__.parent, "core_settings"),
    "NewType": (__spec__.parent, "_logging"),
    ...
    "ValidationError": (__spec__.parent, "core_settings"),
