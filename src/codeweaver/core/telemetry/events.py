    ...
    def to_posthog_event(self) -> tuple[str, dict[str, Any]]:
        ...
        if base_data.get("timing_statistics"):
            ...
            if "timing_summary" in timing_data:
                ...
                properties["timing"] = {
                    "tool_calls": {
                        "avg_ms": timing_summary
                        .get("averages", {})
                        .get("on_call_tool_requests", {})
                        .get("combined", 0.0),
                        "count": timing_summary
                        .get("counts", {})
                        .get("on_call_tool_requests", {})
                        .get("combined", 0),
                    },
                    "http": {
                        "health_avg_ms": timing_summary
                        .get("averages", {})
                        .get("http_requests", {})
                        .get("health", 0.0),
                        "health_count": timing_summary
                        .get("counts", {})
                        .get("http_requests", {})
                        .get("health", 0),
                    },
...
class SearchEvent:
    ...
    def to_posthog_event(self) -> tuple[str, dict[str, Any]]:
        ...
        if self._tools_over_privacy:
            from codeweaver.core.telemetry.utils import redact_identifiable_info
