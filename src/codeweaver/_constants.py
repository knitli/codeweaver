...
DATA_FILES_EXTENSIONS: tuple[ExtLangPair, ...] = (
    ...
    ExtLangPair(ext=".nw", language="nw"),  # Node-Webkit (.zip container with .nw extension) files
    ExtLangPair(ext=".sqlite", language="sql"),
    ExtLangPair(ext=".sqlite3", language="sql"),
    ExtLangPair(ext=".svg", language="xml"),
...
DOC_FILES_EXTENSIONS: tuple[ExtLangPair, ...] = (
    ...
    ExtLangPair(ext=".rdoc", language="markdown"),
...
CODE_FILES_EXTENSIONS: tuple[ExtLangPair, ...] = (
    ...
    ExtLangPair(ext=".astro", language="astro"),
    ...
    ExtLangPair(ext=".duck", language="duck"),
    ExtLangPair(ext=".dyck", language="dyck"),
    ExtLangPair(ext=".e", language="eiffel"),
    ExtLangPair(ext=".ecl", language="ecl"),
    ExtLangPair(ext=".eclsp", language="ecl"),
    ExtLangPair(ext=".eclxml", language="ecl"),
    ...
    ExtLangPair(ext=".jelly", language="jelly"),  # jenkins
    ExtLangPair(ext=".jinja", language="jinja"),
    ExtLangPair(ext=".jinja2", language="jinja"),
    ...
    ExtLangPair(ext=".m", language="matlab"),
    ...
    ExtLangPair(ext=".nimble.json", language="json"),
    ExtLangPair(ext=".nimble.toml", language="toml"),
    ...
    ExtLangPair(ext=".sml", language="sml"),  # Standard ML
    ...
    ExtLangPair(ext=".xaml", language="xml"),
    ExtLangPair(ext=".xhtml", language="xml"),
    ExtLangPair(ext=".xib", language="xml"),
    ExtLangPair(ext=".xlf", language="xml"),
    ExtLangPair(ext=".xlf", language="xml"),
    ExtLangPair(ext=".xmi", language="xml"),
    ExtLangPair(ext=".xml", language="xml"),
    ExtLangPair(ext=".xml.dist", language="xml"),
    ExtLangPair(ext=".xml.in", language="xml"),
    ExtLangPair(ext=".xml.inc", language="xml"),
    ExtLangPair(ext=".xrl", language="erlang"),
    ExtLangPair(ext=".xsd", language="xml"),
    ExtLangPair(ext=".xsh", language="xonsh"),
    ExtLangPair(ext=".xsl", language="xml"),
    ExtLangPair(ext=".yrl", language="erlang"),
    ExtLangPair(ext=".zig", language="zig"),
    ExtLangPair(ext=".zsh", language="zsh"),
