...
from codeweaver.core import ConfigLanguage, LanguageName, LanguageNameT, SemanticSearchLanguage
...
def generate_literal_type_file(languages: list[LanguageNameT], path: Path) -> None:
    ...
    content = black.format_str(
        ...
        \"\"\"Literal type for supported secondary languages. These languages have language-aware chunking support.
