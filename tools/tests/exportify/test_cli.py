...
class TestLazyImportsCLI:
    ...
    def test_cli_module_imports(self):
        ...
        from tools.exportify.cli import app
    ...
    def test_types_module_imports(self):
        ...
        from tools.exportify.types import CacheStatistics, ExportGenerationResult, ValidationReport
    ...
    def test_validator_module_imports(self):
        ...
        from tools.exportify.validator import ImportValidator

        assert ImportValidator is not None

    def test_export_manager_imports(self):
        """Test that export manager modules can be imported."""
        from tools.exportify.export_manager import PropagationGraph, RuleEngine
    ...
    def test_validator_initialization(self):
        ...
        from tools.exportify.common.cache import AnalysisCache
        from tools.exportify.validator import LazyImportValidator
