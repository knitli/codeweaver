...
from tools.exportify.common.types import PropagationLevel, Rule, RuleAction, RuleMatchCriteria
...
if TYPE_CHECKING:
    from tools.exportify.common.types import AnalysisResult, ExportManifest
