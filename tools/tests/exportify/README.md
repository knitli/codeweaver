...
### All Tests
```bash
mise run test tests/tools/exportify/
```

### By Category
```bash
# Unit tests only
mise run test tests/tools/exportify/test_types.py
mise run test tests/tools/exportify/test_rules.py
mise run test tests/tools/exportify/test_graph.py
mise run test tests/tools/exportify/test_cache.py
mise run test tests/tools/exportify/test_validator.py

# Integration tests
mise run test tests/tools/exportify/test_integration.py -m integration

# Performance benchmarks
mise run test tests/tools/exportify/test_benchmarks.py -m benchmark
```

### With Coverage
```bash
mise run test --cov=src/codeweaver/tools/exportify tests/tools/exportify/
```

### Fast Tests Only
```bash
mise run test --profile fast tests/tools/exportify/
```
...
mise run test --cov=src/codeweaver/tools/exportify \
              --cov-report=html \
              tests/tools/exportify/
