...
**File**: `tools/exportify/common/types.py`
...
**File**: `tools/exportify/export_manager/rules.py`
...
```python
from tools.exportify.common.types import (
    # ... existing imports ...
...
**File**: `tools/exportify/rules/README.md`
...
**File**: `tools/exportify/tests/test_rules.py` (new)
...
The AST parser (`tools/exportify/analysis/ast_parser.py`) already sets provenance correctly:
...
- `tools/exportify/common/types.py` - Type definitions
- `tools/exportify/export_manager/rules.py` - Rule engine
- `tools/exportify/analysis/ast_parser.py` - AST parser (sets provenance)
- `tools/exportify/rules/README.md` - Rule schema documentation
- `tools/exportify/tests/test_rules.py` - Test suite
