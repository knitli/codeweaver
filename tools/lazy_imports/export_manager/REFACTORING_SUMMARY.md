...
from tools.lazy_imports.export_manager.file_writer import FileWriter, BackupPolicy
...
1. **Created**: `tools/lazy_imports/export_manager/file_writer.py` (256 lines)
2. **Updated**: `tools/lazy_imports/export_manager/generator.py` (removed ~60 lines of I/O code)
3. **Created**: `tools/tests/lazy_imports/test_file_writer.py` (217 lines)
