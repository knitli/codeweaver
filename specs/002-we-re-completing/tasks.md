...
- [X] **T002** [P] Create configuration models in `src/codeweaver/config/providers.py`
  ...
  - Add `VectorStoreSettings` (provider selection: "qdrant" | "memory")
...
- [X] **T006** [P] Contract test: QdrantVectorStore methods in `tests/contract/test_qdrant_provider.py`
...
- [X] **T007** [P] Contract test: MemoryVectorStore methods in `tests/contract/test_memory_provider.py`
...
- [X] **T011** [P] Integration test: Scenario 4 - In-memory persistence in `tests/integration/test_memory_persistence.py`
  ...
  - Test MemoryVectorStore disk persistence
...
- [ ] **T019** Implement QdrantVectorStore._get_or_create_collection in `src/codeweaver/providers/vector_stores/qdrant.py`
...
- [ ] **T020** Implement QdrantVectorStore._validate_provider_compatibility in `src/codeweaver/providers/vector_stores/qdrant.py`
...
- [ ] **T021** Implement QdrantVectorStore.list_collections in `src/codeweaver/providers/vector_stores/qdrant.py`
  - Call AsyncQdrantClient.get_collections()
  - Extract collection names from response
  - Return list[str] or empty list
  - Handle ConnectionError

- [ ] **T022** Implement QdrantVectorStore.search in `src/codeweaver/providers/vector_stores/qdrant.py`
...
- [ ] **T023** Implement QdrantVectorStore._prepare_query_vector in `src/codeweaver/providers/vector_stores/qdrant.py`
...
- [ ] **T024** Implement QdrantVectorStore._merge_search_results in `src/codeweaver/providers/vector_stores/qdrant.py`
...
- [ ] **T025** Implement QdrantVectorStore.upsert in `src/codeweaver/providers/vector_stores/qdrant.py`
...
- [ ] **T026** Implement QdrantVectorStore.delete_by_file in `src/codeweaver/providers/vector_stores/qdrant.py`
...
- [ ] **T027** Implement QdrantVectorStore.delete_by_id in `src/codeweaver/providers/vector_stores/qdrant.py`
  - Convert UUID4 list to strings
  - Call client.delete(points=ids)
  - Handle CollectionNotFoundError, DeleteError
  - Batch if >1000 IDs

- [ ] **T028** Implement QdrantVectorStore.delete_by_name in `src/codeweaver/providers/vector_stores/qdrant.py`
...
- [ ] **T029** Implement MemoryVectorStore.__init__ in `src/codeweaver/providers/vector_stores/inmemory.py`
  - Accept MemoryConfig
  - Initialize: _persist_path, _auto_persist, _persist_interval
  - Call super().__init__()

- [ ] **T030** Implement MemoryVectorStore._initialize in `src/codeweaver/providers/vector_stores/inmemory.py`
...
- [ ] **T031** Implement MemoryVectorStore._persist_to_disk in `src/codeweaver/providers/vector_stores/inmemory.py`
...
- [ ] **T032** Implement MemoryVectorStore._restore_from_disk in `src/codeweaver/providers/vector_stores/inmemory.py`
...
- [ ] **T033** Implement MemoryVectorStore._periodic_persist_task in `src/codeweaver/providers/vector_stores/inmemory.py`
...
- [ ] **T034** Implement MemoryVectorStore._on_shutdown in `src/codeweaver/providers/vector_stores/inmemory.py`
...
- [ ] **T035** Implement MemoryVectorStore provider methods in `src/codeweaver/providers/vector_stores/inmemory.py`
...
- [X] **T036** Integrate VectorStoreSettings into CodeWeaverSettings in `src/codeweaver/config/settings.py`
  - Add `vector_store: VectorStoreSettings` field with default factory
...
- [X] **T037** Create provider registry integration in `src/codeweaver/providers/vector_stores/__init__.py`
  - Export QdrantVectorStore, MemoryVectorStore, VectorStoreProvider
  - Add provider factory function: get_vector_store_provider(settings: VectorStoreSettings) -> VectorStoreProvider
  - Factory returns QdrantVectorStore or MemoryVectorStore based on settings.provider
...
Task: "Contract test: QdrantVectorStore methods in tests/contract/test_qdrant_provider.py"
Task: "Contract test: MemoryVectorStore methods in tests/contract/test_memory_provider.py"
...
# Process 1 (Qdrant):
Task: "Implement QdrantVectorStore methods T017-T028 in src/codeweaver/providers/vector_stores/qdrant.py"

# Process 2 (Memory) - runs simultaneously:
Task: "Implement MemoryVectorStore methods T029-T035 in src/codeweaver/providers/vector_stores/inmemory.py"
```
...
- [x] All 9 data model entities have implementation tasks:
  ...
  - QdrantVectorStore (T017-T028)
  - MemoryVectorStore (T029-T035)
  - QdrantConfig, MemoryConfig (T002)
  - CollectionMetadata (T003)
  - CodeChunk extensions (T004)
  - VectorStoreSettings (T002)
  - Error types (T001)
